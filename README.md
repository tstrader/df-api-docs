# Seismic POC 2 OpenAPI Specification
[![Build Status](https://travis-ci.org/tstrader/df-api-docs.svg?branch=master)](https://travis-ci.org/tstrader/df-api-docs)
...
6. If you did everything correct, https://tstrader.github.io/df-api-docs/ will lead to your new docs
...
- Documentation(ReDoc): https://tstrader.github.io/df-api-docs/
- SwaggerUI: https://tstrader.github.io/df-api-docs/swagger-ui/
- Look full spec:
    + JSON https://tstrader.github.io/df-api-docs/swagger.json
    + YAML https://tstrader.github.io/df-api-docs/swagger.yaml
- Preview spec version for branch `[branch]`: https://tstrader.github.io/df-api-docs/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://tstrader.github.io/df-api-docs/ with url from the message: `Server started <url>`
